...
namespace BookAppWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        {
            OrderVM.OrderHeader = _unitOfWork.OrderHeader.Get(u=>u.Id == OrderVM.OrderHeader.Id,includeProperty:"ApplicationUser");
            OrderVM.OrderDetail = _unitOfWork.OrderDetail.GetAll(u=>u.OrderHeaderId == OrderVM.OrderHeader.Id,includeProperty:"Product");
